...
if(input.trim() === ''){
    ...
    <span class="hide-element"> <input type="text">  <i onclick="Edit_TaskByUser(event)" class="fa-solid fa-pen-to-square"></i> </span>
     <button onclick="Edit_text(event)" class="editbtn"> Edit </Button>
...
// e.target.classList.toggle("hide-element-show")
